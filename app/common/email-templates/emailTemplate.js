module.exports = ({task_id, task_details, project_no, assignee_name}) => {
    return `
		<!doctype html>
		<html>
		<head>
												...
												<td>
													<p 
														style="font-family: Arial, Helvetica, sans-serif; 
															...
															line-height: 20px;"
														>
														You have been assigned a task for a project. Details are below:
													</p>
												</td>
											</tr>
											<tr>
												...
												<td align="center">
													...
													>
														<tr>
															...
															>
																<a 
																	href="https://wmt.mindit.systems/process-chart/${task_id}"
																	style="font-family: Arial, Helvetica, sans-serif;
																		width: 100%; 
																		background-color:  #e65100;
																		background: linear-gradient(135deg, #e65100 0, #e65100 80%); 
